...
export function MemberEngagementWorkspace({ preview: fixturePreview, liveData }: Props) {
  ...
  return <DashboardSectionAccordion className={styles.workspace} ariaLabel="Member Engagement sections" sections={[
    ...
    { title: "Retention implication", summary: "Verified exit-reason recovery is incomplete." },
    { title: "Cohorts and recovery", summary: "January is 1 point below the approved floor." },
    { title: "Recovery implication", summary: "The remaining at-risk Members determine floor recovery." },
