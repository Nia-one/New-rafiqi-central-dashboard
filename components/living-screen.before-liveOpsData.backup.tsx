...
export function LivingScreen({ focus, allocationFocus }: { focus?: LivingSection; allocationFocus?: string }) {
  ...
  return <DashboardSectionAccordion className="pillar-screen living-screen" ariaLabel="Living sections" sections={[
    ...
    { title: "Monthly pacing", summary: "FONO 920 · Shram Park 862 Members." },
    ...
    <div className="pacing-grid"><PacingCard channel="FONO" actual={920} owner="Franchise Acquisition + Theatre ops" /><PacingCard channel="Shram Park" actual={862} owner="JCO + RM teams" /></div>
