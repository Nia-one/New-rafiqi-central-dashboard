...
export function MemberSavingsWorkspace({ preview }: Props) {
  ...
  return <DashboardSectionAccordion className={styles.workspace} ariaLabel="Member Savings sections" sections={[
    ...
    { title: "Dual-gate implication", summary: "Recovery belongs on the single failing service." },
    { title: "Savings, margin and repeat", summary: `${preview.services.filter((service) => service.status === "Pass").length}/${preview.services.length} services pass` },
