export const DASHBOARD_TABS = ["Overview", "Living", "Work", "Essentials", "People", "Member Feedback", "Economics", "Definitions", "Despatch"] as const
...
export const SELF_LEARN_TABS = ["Overview", "Living", "Work", "Essentials", "Member Feedback", "People", "Definitions"] as const
