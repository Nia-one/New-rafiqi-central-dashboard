...
test("derives backend NPS, feedback and latest-month dashboard metrics from one input", () => {
  const result = deriveMemberFeedback([
    { "member token": "Member A", score: 10, feedback: "Great", "collected at": "2026-06-01", "reporting month": "2026-06", studio: "S1" },
    { "member token": "Member B", score: 6, feedback: "Fix food", "collected at": "2026-07-01", "reporting month": "2026-07", studio: "S1" },
    { "member token": "Member C", score: 9, feedback: "Good", "collected at": "2026-07-02", "reporting month": "2026-07", studio: "S2" },
...
test("rejects incomplete and out-of-range submissions", () => {
  const result = deriveMemberFeedback([
    ...
    { "member token": "Member B", score: 9, "collected at": "2026-07-01", "reporting month": "2026-08" },
  ]);
